...
FCustomComputeShadersViewExtension::FCustomComputeShadersViewExtension(const FAutoRegister& AutoRegister, FLinearColor CustomColor) : FSceneViewExtensionBase(AutoRegister) {
	HighlightColor = CustomColor;
}

void FCustomComputeShadersViewExtension::PrePostProcessPass_RenderThread(FRDGBuilder& GraphBuilder, const FSceneView& View, const FPostProcessingInputs& Inputs) {
	...
	RDG_EVENT_SCOPE(GraphBuilder, "Custom Compute Shader (Example) Render Pass");
