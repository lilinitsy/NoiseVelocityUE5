	...
	const FPostProcessingInputs& inputs)
{
	...
	FGaborNoiseEnhancementCS::FParameters* noise_params =
		graph_builder.AllocParameters<FGaborNoiseEnhancementCS::FParameters>();
	...
	graph_builder.AddPass(
		...
		noise_params,
		ERDGPassFlags::Compute,
		[noise_cs, noise_params, group_count](FRHICommandList& rhi_cmd_list)
		{
			FComputeShaderUtils::Dispatch(rhi_cmd_list, noise_cs, *noise_params, group_count);
		});
